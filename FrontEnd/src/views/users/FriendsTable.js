        ...
        <Card>
            ...
            >
                ...
                <Box sx={{ gap: 4, display: 'flex', flexWrap: 'wrap', alignItems: 'center' }}>
                    <CustomTextField value={value} placeholder='Search Friends' onChange={e => setValue(e.target.value)} />
                </Box>
            </CardContent>
            <DataGrid
                autoHeight
            ...
            >
                ...
                >
                    ...
                    <Box sx={{ mb: 8, textAlign: 'center' }}>
                        ...
                        <Typography sx={{ color: 'text.secondary' }}>Add new friend to your list</Typography>
                    </Box>
